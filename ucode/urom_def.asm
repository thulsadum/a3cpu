...
SIG_FLAGS_IN  = 1 << BUS_OFFSET + 11 ; FLAGS from bus
SIG_FLAGS_OUT  = 1 << BUS_OFFSET + 12 ; FLAGS from bus
SIG_CONST_ADDR_VEC_OUT  = 1 << BUS_OFFSET + 13 ; const 0x0002 to bus
SIG_CONST_ADDR_ISR_OUT  = 1 << BUS_OFFSET + 14 ; const 0x0003 to bus
BUS_END = BUS_OFFSET + 15
